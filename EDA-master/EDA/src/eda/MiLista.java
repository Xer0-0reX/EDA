...
//    
    ...
    public static int reto1(String s1, String s2){
        int con=0,i=0,j=0,t=s2.length(),m=i;
        ...
        if(t>0){
            ...
            while(i<t){  
                ...
                m=i;
                if(b.contains(s2.charAt(i))){
                    System.out.println("Entro al if");
                    if(s1.charAt(j%t)!=s2.charAt(i)){
                        System.out.println("Entro al segundo if");
                    j++;
                    while(s1.charAt(j%t)!=s2.charAt(i)){
                        System.out.println("Entra al segundo while");
                        j++;
                    }
                    a[i]++;
                    while(s1.charAt(j%t)==s2.charAt(m%t) && con!=t){
                        System.out.println("Entra al tercer while");
                        m++;
                        j++;
                        con++;
                    }
                    if(con==t ){
                        System.out.println("Entra al ultimo if");
                        con=1;  
                    i=t;
                    }
                        }
    ...
    public static int edit(String s1, String s2,int cont,int max){
      if(s1.length()==0 || s2.length()==0)
          return cont + s1.length()+s2.length();
      if(cont>=max)
          return max;
        if(s1.charAt(0)==s2.charAt(0))
           return edit(s1.substring(1),s2.substring(2),cont,max);
        int r1=edit(s1.substring(1),s2.substring(1),cont+1,max);
        int r2=edit(s1.substring(1),s2,cont+1,max);
        int r3=edit(s1,s2.substring(1),cont+1,max);
    ...
    r.agrega("1");
        ...
        System.out.println("\n");
        permuta("12345678", "");
        String a="Rodrigo",b="odrigoR";
        System.out.println(a+" "+b+" "+reto1(b, a));
        System.out.println("\n"+edit("12345678", "", 0, 8));
